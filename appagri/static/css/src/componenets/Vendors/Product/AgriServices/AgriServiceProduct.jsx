...
const AgriServiceProduct = ({ vendorStatus, vendorType, productExist, vendorID }) => {
  return (
    <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="flex flex-col items-center">
        <img src="https://res.cloudinary.com/dq7vggsop/image/upload/v1718883965/gyqiymjmcdugchmhwcn0.jpg" alt="Seller Not Approved" style={{ height: "20rem", width: "20rem" }} />
        {productExist ? (
          <div className="mt-4">
            <ShowServices vendorId={vendorID} />
          </div>
        ) : (
...
export default AgriServiceProduct